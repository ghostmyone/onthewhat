...
//EMAIL SETTING GANTI EMAIL HARUS SSL
define('MAILTYPE', 'html');
define('SMTPHOST', 'iix80.cloudhost.id');
define('SMTPUSER', 'admin@mvstore.id');
define('SMTPPASS', '');
...
//google chapca
define('GOOGLEKEY', '');
define('GOOGLESITE_KEY', '');
define('ADMINPHONE', '');

//mvstoreApi

define('SITE_NAME', 'TUTOR.ID');
//webhooks
define('URLAPI', 'https://demo.mvstore.id/webhooks');
define('REF', 'DEMO');
