          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card" style="background:#0b0e2e;">
              ...
              <div class="card-header">
                <h4 class="text-white"><?php echo lang('reset_password_heading');?></h4>
              </div>
              <div class="card-body">
                <?php echo form_open('dashboard/auth/reset_password/' . $code);?>
                  <div class="form-group">
                    <label for="new_password"><?php echo sprintf(lang('reset_password_new_password_label','" class="text-white"'), $min_password_length);?></label>
                    ...
                    <div class="invalid-feedback">
									...
									<div class="form-group">
                    <label for="new_password"><?php echo lang('reset_password_new_password_confirm_label', 'new_password_confirm" class="text-white"');?></label>
                  ...
                  <div class="form-group">
                    <?php echo form_submit('submit', lang('reset_password_submit_btn'), 'class="btn btn-info btn-lg btn-block"');?>
                  </div>
                <?php echo form_close();?>
              </div>
            </div>
