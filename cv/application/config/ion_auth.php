 ...
 */
$config['site_title']                 = "TUTOR.ID";       // Site Title, example.com
$config['admin_email']                = "admin@mvstore.id"; // Admin Email, admin@example.com
...
$config['email_config'] = [
	...
	'charset'   => 'utf-8',
	'protocol'  => 'mail',
	'smtp_host' => 'mail.mvstore.id',
	'smtp_user' => 'admin@mvstore.id',  // Email gmail
