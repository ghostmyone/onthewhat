  ...
  <body class="maincolor">
      ...
      <div class="container" >
        <div class="row">
          <div class=" col-md-12 col-sm-12 col-lg-4">
            <img src="<?php echo $gamePic; ?>" alt="Image" class="rounded img-fluid mt-1">
          ...
          <div class="seccolor col-md-12 col-sm-12 col-lg-7"  style="padding-bottom:30px;">
            ...
            <div class="mt-2">
              <div class="row">
                <div class="col-7">
                  <input value="" nickname="" status="true" class="form-control produkcolor inputid userid" type="text" name="id" id="id" placeholder="Id">
                </div>
                <div class="col-5">
                  <input value="" nickname="" status="true" class="form-control produkcolor inputid userid2" type="text" name="id2" id="id2" placeholder="Id Server">
                </div>
              </div>
            </div>
            <div class="title text-left mt-2" >
    ...
    $( document ).ready(function() {
      ...
      $('.inputid').focusout(function(){
        ...
        var ServerId = $('.userid2').val();
        var cekurl = '<?php echo $gameCekId; ?>';
        if (UserId != '') {
          if (ServerId != '') {
            if (cekurl != '') {
              var newuserid = ''+UserId+ServerId;
              $('.loader').show();
              $.ajax({
                  url: cekurl,
                  cache: false,
