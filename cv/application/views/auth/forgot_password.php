          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card " style="background:#0b0e2e;">
              ...
              <div class="card-header">
                <h4 class="text-white"><?php echo lang('forgot_password_heading');?></h4>
              </div>
              <div class="card-body">
                <?php echo form_open("dashboard/auth/forgot_password");?>
                  <div class="form-group">
                    <label for="identity"><?php echo (($type=='email') ? sprintf(lang('forgot_password_email_label','"class="text-white"'), $identity_label) : sprintf(lang('forgot_password_identity_label','" class="text-white"'), $identity_label));?></label>
                  ...
                  <div class="form-group">
                    <?php echo form_submit('submit', lang('forgot_password_submit_btn'), 'class="btn btn-info btn-lg btn-block"');?>
                  </div>
                <?php echo form_close();?>
              </div>
            </div>
